...
def save_pth(state, args, global_step):
    model_pth = os.path.join(args.output_dir, "checkpoint_step_%s.pth.tar" % global_step)
...
def setup(args):
    ...
    for k,v in model.named_parameters():
        ...
        elif "head.weight" or "head.bias" in k:
            v.requires_grad = False
        else:
...
def train(args, model):
    ...
    t_total = args.num_steps            # 训练epoch数量
    ...
    #----------- Distributed training ----------- （this block will not use in our design）
...
def main():
    ...
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 "ViT-L_32", "ViT-H_14", "R50-ViT-B_16","cnn-ViT-B_16"],
                        default="ViT-B_16",
